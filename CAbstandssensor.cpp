...
//	int CAbstandssensor::readRange(int& pRange)
//	{
//		// wait for device to be ready for range measurement
//		// wenn Bit 0 von RESULT__RANGE_STATUS = 1, next line, sonst weiter pollen in while Schleife
//		  do{
...
//
////		  this->readRangeStatus(mRangeStatus);
////		  this->readRegister(RESULT__RANGE_STATUS, mRangeStatus);
////		  if((mRangeStatus) == VL6180X_ERROR_NONE)
//			  pRange = mRange;
////		  else
////			  this->getError();
//
...
/*	int CAbstandssensor::Mittelwert(int& pWert)
	{
		pWert = (Buffer[0] + Buffer[1] + Buffer[2]) / 3;
		return 0;
	}
	*/
